...
// GameScreen::GameScreen(sf::RenderWindow &ScreenWindow) 
//     :   FloweryScreen(ScreenWindow),
//         //TimeCounter(sf::Text(Field.ResourcesHandler.GameCounterFont, Field.ClockToString())),
//         FlagCounter(sf::Text(ResourcesHandler.GameCounterFont, FlagsToCounter())),
//         RestartButton(FloweryButton(sf::RectangleShape({50.f, 20.f}), sf::Text(ResourcesHandler.GameCounterFont, "Quit game"))),
//         QuitButton(FloweryButton(FloweryButton(sf::RectangleShape({50.f, 20.f}), sf::Text(ResourcesHandler.GameCounterFont, "Reset game"))))
// {
...
//     FlagCounter.setPosition(sf::Vector2f(static_cast<float>(ScreenWindow.x + FlagCounter.getLocalBounds().size.x + 30), static_cast<float>(Field.Window.getSize().y + 5)));
